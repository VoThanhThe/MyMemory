...
import { ApiController, AssetUtil, ConnectionController, ConnectorController, EventUtil, EventsController, OptionsController, RouterController } from '@web3modal/core-react-native';
...
export function ConnectView() {
  ...
  const walletsTemplate = () => {
    ...
    return list.slice(0, UiUtil.TOTAL_VISIBLE_WALLETS - RECENT_COUNT).map(wallet => /*#__PURE__*/React.createElement(ListWallet, {
      key: wallet?.id,
      imageSrc: AssetUtil.getWalletImage(wallet),
      imageHeaders: imageHeaders,
      name: wallet?.name ?? 'Unknown',
