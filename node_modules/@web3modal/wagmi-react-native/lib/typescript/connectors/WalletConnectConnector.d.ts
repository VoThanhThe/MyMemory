...
export type WalletClient<TTransport extends Transport = Transport, TChain extends Chain = Chain, TAccount extends Account = Account> = WalletClient_<TTransport, TChain, TAccount>;
...
export declare class WalletConnectConnector extends Connector<WalletConnectProvider, WalletConnectOptions> {
    ...
    _createProvider(): Promise<void>;
    _initProvider(): Promise<void>;
    /**
    ...
    _setRequestedChainsIds(chains: number[]): void;
    _getRequestedChainsIds(): Promise<number[]>;
    _getNamespaceChainsIds(): number[];
    _getNamespaceMethods(): string[];
