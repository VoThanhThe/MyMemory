...
import { EthereumProvider, OPTIONAL_EVENTS, OPTIONAL_METHODS } from '@walletconnect/ethereum-provider';
...
export class WalletConnectConnector extends Connector {
  ...
  async connect({
    ...
    try {
      ...
      if (!targetChainId) {
        const store = await StorageUtil.getItem(STORE_KEY);
  ...
  async _getRequestedChainsIds() {
    const requestedChains = await StorageUtil.getItem(REQUESTED_CHAINS_KEY);
